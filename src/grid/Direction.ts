...
export class Direction {
    ...
    static SOUTH_WEST = new Direction(-1, 1, new Vector3(0, Math.PI * 5 / 3, 0), new Vector3(3.5, 0, -2).normalize())
    static NORTH_WEST = new Direction(0, -1, new Vector3(0, Math.PI / 3, 0), new Vector3(-3.5, 0, -2).normalize())
    static SOUTH_EAST = new Direction(0, 1, new Vector3(0, Math.PI * 4 / 3, 0), new Vector3(3.5, 0, 2).normalize())
